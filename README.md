...
4.	The Player enters a letter. If the word contains such a letter, it will be displayed as, for example: --a--- and it will be suggested to the Player to continue guessing letters. When all the letters of the word are guessed, the Players gets a message “You won”. If there is no such a letter in the word, the Players gets a message “You suck!”.
